...
WARN="-Werror -std=c99 -pedantic -Wall -Wextra -Wdeclaration-after-statement -Wshadow -Wmissing-prototypes -Wstrict-prototypes"
...
if [ "$out" != "$expected" ]; then
	bad "lc files: got '$out', want '$expected'"
else
	printf '  files      -> ok\n'
fi
